...
- Компактная реализация полок в шкафах. Шкаф представляется как двумерная матрица, позиция книги хранится в едином столбце-числе и вычисляется по формуле номер_полки \* размер_полок_в_шкафу + позиция_на_полке 
### Недостатки
...
- Плохой нейминг в UIFuelds (длинные названия полей)
